...
string Employer::get_head_of_team() {
    return head_of_team;
}
...
void Employer::payment(int months) {
    cout << "Po " << months << " miesiacach, szef " << name << " " << surname << " otrzyma " << salary * months
         << " wyplaty" << endl;
}

void Employer::payment(double bonus) {
    cout << "Przy podwyzce rownej " << bonus << " szef " << name << " " << surname << " otrzyma "
         << salary + salary * bonus << " wyplaty" << endl;
}
